...
//	{
//		Clear(core::ThreadType::Game);
//		Clear(core::ThreadType::Render);
//		SH_INFO("~Drawable");
//	}
//
//	void VulkanDrawable::Clear(core::ThreadType thr)
//	{
...
//			renderPass = context.GetMainRenderPass();
//		else
//			renderPass = static_cast<const VulkanFramebuffer*>(camera->GetRenderTexture()->GetFramebuffer(core::ThreadType::Game))->GetRenderPass()->GetVkRenderPass();
//
//		std::size_t passIdx = 0;
//		for (auto& shaderPass : mat->GetShader()->GetShaderPasses())
//			perPassData[thr][passIdx++].pipelineHandle = context.GetPipelineManager().GetOrCreatePipelineHandle(renderPass, static_cast<VulkanShaderPass&>(*shaderPass), *mesh);
//	}
//
