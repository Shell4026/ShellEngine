...
namespace sh::render
{
	...
	public:
		...
		SH_RENDER_API static auto CreateUniformBuffer(const IRenderContext& context, const ShaderPass& shader, UniformStructLayout::Type type) -> std::unique_ptr<IUniformBuffer>;
	};
}//namespace